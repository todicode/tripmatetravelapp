...
Bộ giao tiếp để backend và frontend phát triển độc lập, phiên bản **1.1.0 — 22/09/2026**.

- [openapi.json](openapi.json): **69 operation REST**, request/response/schema, quyền, lỗi, ví dụ; STOMP và FCM trong x-realtime/x-push.
